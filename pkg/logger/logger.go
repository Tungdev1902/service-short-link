...
// getLogDir determines the log directory, preferring LOG_DIR env, then /app/logs, then ./logs
...
func Debug(msg string, fields map[string]interface{}) {
	debugLog := &lumberjack.Logger{
		Filename:   filepath.Join(getLogDir(), "debug.log"),
...
func Error(msg string, fields map[string]interface{}) {
	errorLogPath := filepath.Join(getLogDir(), "error.log")
